...
public class Wiki implements Serializable
{
    ...
    public Map<String, Integer> getSiteStatistics() throws IOException
    {
        ...
        Map<String, Integer> ret = new HashMap<String,Integer>(20);
    ...
    public static String[] intersection(String[] a, String[] b)
    {
        ...
        List<String> intersec = new ArrayList<String>(5000); // silly workaround
    ...
    {
        List<String> compl = new ArrayList<String>(5000); // silly workaround
    ...
    public Map[] getPageInfo(String[] pages) throws IOException
    {
        ...
        for (String temp : constructTitleString(url.length(), pages, true))
        {
            ...
            for (int j = line.indexOf("<page "); j > 0; j = line.indexOf("<page ", ++j))
            {
                ...
                Map<String, Object> tempmap = new HashMap<String,Object>(15);
                ...
                Map<String, Object> protectionstate = new HashMap<String,Object>();
    ...
    public String[] getImagesOnPage(String title) throws IOException
    {
        ...
        List<String> images = new ArrayList<String>(750);
    ...
    public String[] getCategories(String title, boolean sortkey, boolean ignoreHidden) throws IOException
    {
        ...
        List<String> categories = new ArrayList<String>(750);
    ...
    public Map<String, String> getInterWikiLinks(String title) throws IOException
    {
        ...
        Map<String, String> interwikis = new HashMap<String,String>(750);
    ...
    public String[] getLinksOnPage(String title) throws IOException
    {
        ...
        List<String> links = new ArrayList<String>(750);
        do
        {
            String line;
            if (plcontinue == null)
    ...
    public Map<String, Object> getFileMetadata(String file) throws IOException
    {
        ...
        String url = query + "prop=imageinfo&iiprop=url%7Csize%7Cdimensions%7Csha1%7Cmime%7Cmetadata&titles="
            + encode("File:" + file, true);
        url += "&iiurlwidth=75&iiurlheight=75";
        System.out.println("WIKI image info url : "+url);
        ...
        metadata.put("url", parseAttribute(line, "url", 0));
        metadata.put("thumburl", parseAttribute(line, "thumburl", 0));
        ...
        metadata.put("thumbwidth", new Integer(parseAttribute(line, "thumbwidth", 0)));
        metadata.put("thumbheight", new Integer(parseAttribute(line, "thumbheight", 0)));
    ...
    protected String multipartPost(String url, Map<String, ?> params, String caller) throws IOException
    {
        ...
        do
        {
            ...
            try
            {
                ...
                OutputStream uout = null;
                try {
                    uout = connection.getOutputStream();
