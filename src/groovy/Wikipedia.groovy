...
class Wikipedia {
    ...
    //private static final String CLIENT_ID     = grailsApplication.config.auth.wikipedia.CLIENT_ID
    //private static final String CLIENT_SECRET = grailsApplication.config.auth.wikipedia.CLIENT_SECRET
